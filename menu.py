...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_restart.setGeometry(QtCore.QRect(10, 10, 81, 41))
        font = QtGui.QFont()
        font.setFamily("黑体")
        ...
        self.lbl_time.setGeometry(QtCore.QRect(605, 20, 71, 21))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(11)
        ...
        self.lbl_time_value = QtWidgets.QLabel(Form)
        self.lbl_time_value.setGeometry(QtCore.QRect(683, 20, 61, 21))
        font = QtGui.QFont()
        font.setFamily("华文隶书")
        font.setPointSize(11)
        self.lbl_time_value.setFont(font)
